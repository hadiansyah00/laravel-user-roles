...
<div class="row">
    <div class="col-lg-12 margin-tb">
        ...
        <div class="pull-right">
            <a class="btn btn-primary btn-sm" href="{{ route('matakuliah.index') }}">
    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                <input type="number" name="semester" class="form-control" placeholder="Semester" min="1" required>
            </div>
        </div>
            ...
            <div class="form-group">
                ...
                <select name="program_studi_id" class="form-control" required>
                    ...
                    @foreach ($programStudi as $prodi)
                        <option value="{{ $prodi->program_studi_id }}">{{ $prodi->name }}</option>
                    @endforeach
                </select>
            </div>
        </div>
